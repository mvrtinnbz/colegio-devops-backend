package com.colegio.asistencia_service.exception;
...
public class GlobalExceptionHandlerTest {
    ...
    void testHandleValidationExceptions() {
        ...
        FieldError errorSimulado = new FieldError("asistencia", "fecha", "La fecha es obligatoria");
        ...
        assertEquals("La fecha es obligatoria", errores.get("fecha"));
    }
}